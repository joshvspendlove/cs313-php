  ...
  <body class="container-fluid">
    ...
    <div class="content">
	  ...
	  if ($systemid != 0)
	  {
		  ...
		  {			  
			  echo '<div class="row"><div class="col-sm"><h4>' . $light['lightname'] . '</h4></div><div class="col-sm"><h4><label id="lightstate' . $light["deviceid"] . '">';
			  ...
			  echo '><span class="slider light"></span></label></h4></div></div><hr>';
		  }
		...
		<div class="card">
          ...
          <div class="card-body">
             <?php
				...
				{
					echo '<div class="row"><div class="col-sm"><h4>' . $lock['lockname'] . '</h4></div><div class="col-sm"><h4><label id="lockstate'. $lock["deviceid"] . '">' . $lock['lockstate'] .' </label><label class="switch"><input type="checkbox" id="' . $lock["deviceid"] .'" onchange="toggleLock(id);" ';
					if ($lock['lockstate'] == "Locked")
					{
						echo 'checked';
					}
			  
					echo '><span class="slider lock"></span></label></h4></div></div><hr>';
				}
