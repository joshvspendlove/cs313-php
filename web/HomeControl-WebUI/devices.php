  ...
  <body class="container-fluid">
    ...
    <div class="content">
	  ...
	  if ($systemid != 0)
	  {
		  ...
		  {			  
			  echo '<div class="row"><div class="col-sm"><h4>' . $light['lightname'] . '</h4></div><div class="col-sm"><label class="switch"><input type="checkbox" id="' . $light["deviceid"] .'" onchange="toggleLight(id);" ';
		...
		<div class="card">
          ...
          <div class="card-body">
             <?php
				...
				{
					echo '<div class="row"><div class="col-sm"><h4>' . $lock['lockname'] . '</h4></div><div class="col-sm"><label class="switch"><input type="checkbox" id="' . $lock["deviceid"] .'" onchange="toggleLock(id);" ';
